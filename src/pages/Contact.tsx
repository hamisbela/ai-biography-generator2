...
import { Mail, UserCircle, Phone, Send } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Have questions about our AI Biography Generator? Get in touch!
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">contact@aibiographygenerator.com</p>
              </Card>
            </div>
            ...
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">@AIBioGenerator</p>
              </Card>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="Tell us how we can help with your biography needs..."
                  />
                </div>
